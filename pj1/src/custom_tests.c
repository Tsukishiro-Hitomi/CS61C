...
bool test_get_next_row() {
  // TODO: Implement this function.
  char testcase_1_char = 'w';
  unsigned int testcase_1_int = 5;
  int expected_1 = 4;
  int output_1 = get_next_row(testcase_1_int, testcase_1_char);
  if(!assert_equals_int("output_1", expected_1, output_1)) {
    return false;
  }

  char testcase_2_char = 't';
  unsigned int testcase_2_int = 5;
  int expected_2 = 5;
  int output_2 = get_next_row(testcase_2_int, testcase_2_char);
  if(!assert_equals_int("output_2", expected_2, output_2)) {
    return false;
  }
...
bool test_get_next_col() {
  // TODO: Implement this function.
  char testcase_1_char = 'a';
  unsigned int testcase_1_int = 5;
  int expected_1 = 4;
  int output_1 = get_next_col(testcase_1_int, testcase_1_char);
  if(!assert_equals_int("output_1", expected_1, output_1)) {
    return false;
  }
  ...
  unsigned int testcase_2_int = 5;
  int expected_2 = 5;
  int output_2 = get_next_col(testcase_2_int, testcase_2_char);
  if(!assert_equals_int("output_2", expected_2, output_2)) {
    return false;
  }
  return true;
